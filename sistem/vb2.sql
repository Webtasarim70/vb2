...
--
-- Anamakine: localhost
-- Üretim Zamanı: 02 Ağu 2018, 14:46:30
...
(1, 'http://localhost/vb2', 'yenidizi.club', 'yenidizi.club', 'yenidizi.club', 'yenidizi.club', 'Yavuz Selim ŞAHİN -2017 x', 'AIzaSyCM5jaVAHWTEnCvu0SbF1yenwuQedevmAc');
...
INSERT INTO `yorumlar` (`yorum_id`, `yorum_video_id`, `yorum_isim`, `yorum_eposta`, `yorum_website`, `yorum_icerik`, `yorum_durum`) VALUES
(1, 2, 'deneme', 'deneme@deneme.com', 'deneme.com', 'deneme yorum', 0);
