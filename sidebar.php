<div id="sidebar" class="col-md-4">
    ...
    <div class="line"></div>
                ...
                <div class="widget wid-tags">
                    <div class="heading"><h4><i class="fa fa-tags"></i> Etiketler</h4></div>
                    <div class="content">
                        <ul class="list-inline">
                ...
                <!---- Start Widget  Categor---->
                <div class="widget wid-post">
                    <div class="heading"><h4><i class="fa fa-globe"></i> Kategoriler</h4></div>
                    <div class="content">
                ...
                <div class="widget wid-news">
                    <div class="heading"><h4><i class="fa fa-clock-o"></i> Haberler </h4></div>
                    <div class="content">
                        <div class="wrap-vid">
                            <div class="zoom-container">
                                <div class="zoom-caption">
                ...
                <div class="widget wid-post">
                    <div class="heading"><h4><i class="fa fa-comments"></i> Yorumlar</h4></div>
                    <div class="content">
                        <div class="post">
                            <a href="single.html">
